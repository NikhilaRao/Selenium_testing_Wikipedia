...
public class WikipediaTest {
	...
	public void wikiSignIn() {
		...
		assertTrue("Validation FAILED -Text \" Wikipedia\" NOT FOUND", response.contains("Wikipedia"));
		...
		// "\\h1[contains(text(), 'Wikipedia')]" ) );
		assertTrue("Validation FAILED -Text \" Northern lights\" NOT FOUND", response.contains("Northern lights"));
		...
		response = driver.getPageSource();
		assertTrue("Validation FAILED -Text \" Log out\" NOT FOUND", response.contains("Log out"));
	...
	public void LoginFail() {
		...
		String errorResponse = driver.getPageSource();
		assertTrue("Validation FAILED -Text \" Login error\" NOT FOUND", 
					errorResponse.contains("Login error"));
